...
Public Class Form1
    ...
    Private Sub BuildBetList()
        ...
        Dim filter5 = "back >'1.7' and back <'2.9' and runnername='Over 3.5 Goals' and inPlay='NL' " 'Holland O45 Lay
        ...
        Dim filter28 = " back > '3.9' and back <'4.5' and runnerName = 'Over 3.5 Goals' and inPlay = 'Fr'" 'FR O3.5 Back
        Dim filter29 = " back > '3.9' and back <'4.5' and runnerName = 'Over 3.5 Goals' and inPlay = 'Fr'" 'FR O4.5 Back
